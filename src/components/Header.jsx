...
const Header = () => {
    ...
    const scrollToExplore = (e) => {
        ...
        const mensCrousel = (e) => {
            ...
            const homeCrousel = (e) => {
                e.preventDefault();
                const homeCrousel = document.getElementById('home');
                if (homeCrousel) {
                    homeCrousel.scrollIntoView({ behavior: 'smooth' });
                }
            };
...
return (
    <header className='header'>
        ...
        <div className='ulli'>
          ...
          <a href="/pages" className="dropdown-toggle">Pages</a>
          <ul className="dropdown-menu">
            ...
            <Link to="/contact-us">Contact Us</Link>  
                    ...
                    <li className="dropdown-container">
          <a href="/contact" className="dropdown-toggle">Features</a>
          <ul className="dropdown-menu">
            ...
            <li><a href="#feature4">Feature 4</a></li>
                    ...
                    <li>
                    <a href="#explore-section" onClick={scrollToExplore}>Explore</a>
                    </li>
                </ul>
            </nav>
        </div>
